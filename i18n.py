...
STYLE_LABELS = {
    ...
    "drift_racer": {
        "uz": "🏎 Drift avtoportret",
        "ru": "🏎 Дрифт-автопортрет",
        "kk": "🏎 Дрифт автопортреті",
        "tg": "🏎 Автопортрети дрифт",
        "ky": "🏎 Дрифт автопортрети",
        "en": "🏎 Drift racer",
    },
    "grand_prix_driver": {
        "uz": "🏁 Poyga uslubi",
    ...
    "moody_studio_portrait": {
        ...
        "kk": "💡 Студиялық портрет",
        "tg": "💡 Портрети студиягӣ",
        "ky": "💡 Студиялык портрет",
        "en": "💡 Studio portrait",
    },
    "vintage_sketch": {
        "uz": "🕰 Retro 80-lar",
